The Workspace ID and Artifact/Item ID can be found from the address bar in your browser when you are in the settings page for that item(please provide the full link in **text** instead of a screenshot) : 
