...
- Backup files (.abf) located in `C:\Backup`. Change the parameter value below if you put your .abf backup files in other folder.
- Ensure that you have C:\temp\ folder , or you can specify other temp folder that holds temp xmla scripts.
- For "$serverName = "YourSSASServer"", you may need to specify YourSSASServer\SSASInstanceName if your SSAS is NOT a default instance (if it's a named instance)
